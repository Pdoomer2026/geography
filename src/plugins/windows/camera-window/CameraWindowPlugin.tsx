 ...
 *
 * Camera Plugin 専用 UI（Day59 新規作成・Registry対応）
 *
 * 設計原則:
...
export function CameraWindowPlugin() {
  ...
  // activeLayer の Camera params を Registry から取得するヘルパー
  ...
  // 200ms ポーリング：Camera Plugin ID の変化検知のみ
  useEffect(() => {
