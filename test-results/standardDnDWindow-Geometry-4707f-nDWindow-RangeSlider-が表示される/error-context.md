...
- Name: standardDnDWindow.spec.ts >> GeometryStandardDnDWindow >> RangeSlider が表示される
- Location: tests/e2e/standardDnDWindow.spec.ts:18:3
...
Locator: getByText('GEOMETRY STD D&D')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('GEOMETRY STD D&D')
